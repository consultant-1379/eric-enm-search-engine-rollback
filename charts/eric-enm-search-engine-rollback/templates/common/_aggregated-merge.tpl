...
{{- define "eric-enm-search-engine-rollback.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-enm-search-engine-rollback.mergeAnnotations" -}}
  {{- include "eric-enm-search-engine-rollback.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-enm-search-engine-rollback.mergeLabels" -}}
  {{- include "eric-enm-search-engine-rollback.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}